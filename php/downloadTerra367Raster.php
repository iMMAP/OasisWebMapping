...
$layerConf = getlayerConf($sentparams,'TerraBands3-6-7');
...
$output = shell_exec("C:\\ms4w\\tools\\gdal-ogr\\gdal_translate -of Gtiff -co tfw=yes -a_ullr 60.002900 38.003900 78.002900 23.001000 -a_srs EPSG:4326 c:\\ms4w\\apache\\htdocs\\oasisweb\\php\\tmp\\Pakistan.".$yearNum.$dayNum.".terra.367.250m.jpg c:\\ms4w\\apache\\htdocs\\oasisweb\\php\\tmp\\".$layerConf['layername'].".tif");
								
unlink("tmp/Pakistan.".$yearNum.$dayNum.".terra.367.250m.jpg");
unlink("tmp/Pakistan.".$yearNum.$dayNum.".terra.367.250m.kml");
